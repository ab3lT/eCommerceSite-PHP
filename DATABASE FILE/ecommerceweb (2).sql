...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 23, 2024 at 08:28 PM
...
CREATE TABLE IF NOT EXISTS `tbl_customer` (
  ...
  `cust_cname` varchar(255) DEFAULT NULL,
  ...
  `cust_b_name` varchar(255) DEFAULT NULL,
  `cust_b_cname` varchar(255) DEFAULT NULL,
  `cust_b_phone` varchar(255) DEFAULT NULL,
  `cust_b_country` varchar(255) DEFAULT NULL,
  `cust_b_address` text DEFAULT NULL,
  `cust_b_city` varchar(255) DEFAULT NULL,
  `cust_b_state` varchar(255) DEFAULT NULL,
  `cust_b_zip` varchar(255) DEFAULT NULL,
  `cust_s_name` varchar(255) DEFAULT NULL,
  `cust_s_cname` varchar(255) DEFAULT NULL,
  `cust_s_phone` varchar(255) DEFAULT NULL,
  `cust_s_country` varchar(255) DEFAULT NULL,
  `cust_s_address` text DEFAULT NULL,
  `cust_s_city` varchar(255) DEFAULT NULL,
  `cust_s_state` varchar(255) DEFAULT NULL,
  `cust_s_zip` varchar(255) DEFAULT NULL,
  `cust_password` varchar(255) NOT NULL,
  `cust_token` varchar(255) NOT NULL,
  `cust_datetime` datetime NOT NULL,
  `cust_timestamp` int(11) NOT NULL,
...
(1, 'Abel', 'none', 'admin@mail.com', '0943317021', '67', 'Addis Abeba', 'Addis Abeba', 'NJ', '08902', 'Abel', 'hj', '0943317021', '67', 'Addis Abeba', 'Addis Abeba', 'NJ', '08902', 'Abel', '', '0943317021', '67', 'Addis Abeba', 'Addis Abeba', 'NJ', '08902', '0192023a7bbd73250516f069df18b500', 'fb3a49c7ba5d4bef4159568156291040', '2024-06-23 01:17:37', 1719173857, 1);
